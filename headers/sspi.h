...
#define SEC_SUCCESS(Status) ((Status) >= 0)
  ...
  typedef unsigned int *PTimeStamp;
#endif
...
#define SECBUFFER_RESERVED 0x60000000
  ...
  typedef struct _SEC_APPLICATION_PROTOCOLS {
    unsigned int ProtocolListsSize;
...
#define PSecPkgCredentials_Names __MINGW_NAME_AW(PSecPkgCredentials_Names)
  ...
  typedef struct _SecPkgCredentials_SSIProviderW {
    ...
    unsigned int ProviderInfoLength;
    char *ProviderInfo;
...
#define SECPKG_ATTR_NEGO_INFO_FLAG_NO_NTLM 0x2
  ...
  typedef struct _SecPkgContext_CredInfo {
    ...
    unsigned int IsPromptingNeeded;
...
#define PSecPkgContext_CredentialName __MINGW_NAME_AW(PSecPkgContext_CredentialName)
  ...
  typedef struct _SecPkgContext_TargetInformation {
    unsigned int MarshalledTargetInfoLength;
...
#define MAX_PROTOCOL_ID_SIZE 0xff
  ...
  typedef void (WINAPI *SEC_GET_KEY_FN) (void *Arg,void *Principal,unsigned int KeyVer,void **Key,SECURITY_STATUS *Status);
...
#define SECPKG_CONTEXT_EXPORT_TO_KERNEL 0x00000004
...
#endif
    int64_t fCredentialUse,void *pvLogonId,void *pAuthData,SEC_GET_KEY_FN pGetKeyFn,void *pvGetKeyArgument,PCredHandle phCredential,PTimeStamp ptsExpiry);
  ...
  typedef SECURITY_STATUS (WINAPI *ACQUIRE_CREDENTIALS_HANDLE_FN_W)(
    ...
    SEC_WCHAR *,SEC_WCHAR *,
#endif
    unsigned int,void *,void *,SEC_GET_KEY_FN,void *,PCredHandle,PTimeStamp);

  SECURITY_STATUS WINAPI AcquireCredentialsHandleA(SEC_CHAR *pszPrincipal,SEC_CHAR *pszPackage,unsigned int fCredentialUse,void *pvLogonId,void *pAuthData,SEC_GET_KEY_FN pGetKeyFn,void *pvGetKeyArgument,PCredHandle phCredential,PTimeStamp ptsExpiry);

  typedef SECURITY_STATUS (WINAPI *ACQUIRE_CREDENTIALS_HANDLE_FN_A)(SEC_CHAR *,SEC_CHAR *,unsigned int,void *,void *,SEC_GET_KEY_FN,void *,PCredHandle,PTimeStamp);
...
#define ACQUIRE_CREDENTIALS_HANDLE_FN __MINGW_NAME_UAW(ACQUIRE_CREDENTIALS_HANDLE_FN)
  ...
  KSECDDDECLSPEC SECURITY_STATUS WINAPI AddCredentialsW(PCredHandle hCredentials,
    ...
    SEC_WCHAR *pszPrincipal,SEC_WCHAR *pszPackage,
#endif
    unsigned int fCredentialUse,void *pAuthData,SEC_GET_KEY_FN pGetKeyFn,void *pvGetKeyArgument,PTimeStamp ptsExpiry);
  ...
  typedef SECURITY_STATUS (WINAPI *ADD_CREDENTIALS_FN_W)(PCredHandle,
    ...
    SEC_WCHAR *,SEC_WCHAR *,
#endif
    unsigned int,void *,SEC_GET_KEY_FN,void *,PTimeStamp);

  SECURITY_STATUS WINAPI AddCredentialsA(PCredHandle hCredentials,SEC_CHAR *pszPrincipal,SEC_CHAR *pszPackage,unsigned int fCredentialUse,void *pAuthData,SEC_GET_KEY_FN pGetKeyFn,void *pvGetKeyArgument,PTimeStamp ptsExpiry);

  typedef SECURITY_STATUS (WINAPI *ADD_CREDENTIALS_FN_A)(PCredHandle,SEC_CHAR *,SEC_CHAR *,unsigned int,void *,SEC_GET_KEY_FN,void *,PTimeStamp);
...
#define ADD_CREDENTIALS_FN __MINGW_NAME_UAW(ADD_CREDENTIALS_FN)
...
#endif
    unsigned int fContextReq,unsigned int Reserved1,unsigned int TargetDataRep,PSecBufferDesc pInput,unsigned int Reserved2,PCtxtHandle phNewContext,PSecBufferDesc pOutput,unsigned int *pfContextAttr,PTimeStamp ptsExpiry);
  ...
  typedef SECURITY_STATUS (WINAPI *INITIALIZE_SECURITY_CONTEXT_FN_W)(PCredHandle,PCtxtHandle,
    ...
    SEC_WCHAR *,
#endif
    unsigned int,unsigned int,unsigned int,PSecBufferDesc,unsigned int,PCtxtHandle,PSecBufferDesc,unsigned int *,PTimeStamp);

  SECURITY_STATUS WINAPI InitializeSecurityContextA(PCredHandle phCredential,PCtxtHandle phContext,SEC_CHAR *pszTargetName,unsigned int fContextReq,unsigned int Reserved1,unsigned int TargetDataRep,PSecBufferDesc pInput,unsigned int Reserved2,PCtxtHandle phNewContext,PSecBufferDesc pOutput,unsigned int *pfContextAttr,PTimeStamp ptsExpiry);

  typedef SECURITY_STATUS (WINAPI *INITIALIZE_SECURITY_CONTEXT_FN_A)(PCredHandle,PCtxtHandle,SEC_CHAR *,unsigned int,unsigned int,unsigned int,PSecBufferDesc,unsigned int,PCtxtHandle,PSecBufferDesc,unsigned int *,PTimeStamp);
...
#define INITIALIZE_SECURITY_CONTEXT_FN __MINGW_NAME_UAW(INITIALIZE_SECURITY_CONTEXT_FN)
  ...
  KSECDDDECLSPEC SECURITY_STATUS WINAPI AcceptSecurityContext(PCredHandle phCredential,PCtxtHandle phContext,PSecBufferDesc pInput,unsigned int fContextReq,unsigned int TargetDataRep,PCtxtHandle phNewContext,PSecBufferDesc pOutput,unsigned int *pfContextAttr,PTimeStamp ptsExpiry);

  typedef SECURITY_STATUS (WINAPI *ACCEPT_SECURITY_CONTEXT_FN)(PCredHandle,PCtxtHandle,PSecBufferDesc,unsigned int,unsigned int,PCtxtHandle,PSecBufferDesc,unsigned int *,PTimeStamp);
  ...
  KSECDDDECLSPEC SECURITY_STATUS WINAPI QueryContextAttributesW(PCtxtHandle phContext,unsigned int ulAttribute,void *pBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CONTEXT_ATTRIBUTES_FN_W)(PCtxtHandle,unsigned int,void *);

  SECURITY_STATUS WINAPI QueryContextAttributesA(PCtxtHandle phContext,unsigned int ulAttribute,void *pBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CONTEXT_ATTRIBUTES_FN_A)(PCtxtHandle,unsigned int,void *);
...
#define QUERY_CONTEXT_ATTRIBUTES_FN __MINGW_NAME_UAW(QUERY_CONTEXT_ATTRIBUTES_FN)
  ...
  SECURITY_STATUS WINAPI QueryContextAttributesExW(PCtxtHandle phContext,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CONTEXT_ATTRIBUTES_EX_FN_W)(PCtxtHandle,unsigned int,void*,unsigned int);

  SECURITY_STATUS WINAPI QueryContextAttributesExA(PCtxtHandle phContext,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CONTEXT_ATTRIBUTES_EX_FN_A)(PCtxtHandle,unsigned int,void*,unsigned int);
...
#define QUERY_CONTEXT_ATTRIBUTES_EX_FN __MINGW_NAME_UAW(QUERY_CONTEXT_ATTRIBUTES_EX_FN)
  ...
  SECURITY_STATUS WINAPI SetContextAttributesW(PCtxtHandle phContext,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *SET_CONTEXT_ATTRIBUTES_FN_W)(PCtxtHandle,unsigned int,void *,unsigned int);

  SECURITY_STATUS WINAPI SetContextAttributesA(PCtxtHandle phContext,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *SET_CONTEXT_ATTRIBUTES_FN_A)(PCtxtHandle,unsigned int,void *,unsigned int);
...
#define SET_CONTEXT_ATTRIBUTES_FN __MINGW_NAME_UAW(SET_CONTEXT_ATTRIBUTES_FN)
  ...
  KSECDDDECLSPEC SECURITY_STATUS WINAPI QueryCredentialsAttributesW(PCredHandle phCredential,unsigned int ulAttribute,void *pBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_FN_W)(PCredHandle,unsigned int,void *);

  SECURITY_STATUS WINAPI QueryCredentialsAttributesA(PCredHandle phCredential,unsigned int ulAttribute,void *pBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_FN_A)(PCredHandle,unsigned int,void *);
...
#define QUERY_CREDENTIALS_ATTRIBUTES_FN __MINGW_NAME_UAW(QUERY_CREDENTIALS_ATTRIBUTES_FN)
  ...
  SECURITY_STATUS WINAPI QueryCredentialsAttributesExW(PCredHandle phCredential,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_W)(PCredHandle,unsigned int,void*,unsigned int);

  SECURITY_STATUS WINAPI QueryCredentialsAttributesExA(PCredHandle phCredential,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_A)(PCredHandle,unsigned int,void*,unsigned int);
...
#define QUERY_CREDENTIALS_ATTRIBUTES_EX_FN __MINGW_NAME_UAW(QUERY_CREDENTIALS_ATTRIBUTES_EX_FN)
  ...
  KSECDDDECLSPEC SECURITY_STATUS WINAPI SetCredentialsAttributesW(PCredHandle phCredential,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *SET_CREDENTIALS_ATTRIBUTES_FN_W)(PCredHandle,unsigned int,void *,unsigned int);

  SECURITY_STATUS WINAPI SetCredentialsAttributesA(PCredHandle phCredential,unsigned int ulAttribute,void *pBuffer,unsigned int cbBuffer);

  typedef SECURITY_STATUS (WINAPI *SET_CREDENTIALS_ATTRIBUTES_FN_A)(PCredHandle,unsigned int,void *,unsigned int);
...
#define SET_CREDENTIALS_ATTRIBUTES_FN __MINGW_NAME_UAW(SET_CREDENTIALS_ATTRIBUTES_FN)
  ...
  KSECDDDECLSPEC SECURITY_STATUS WINAPI MakeSignature(PCtxtHandle phContext,unsigned int fQOP,PSecBufferDesc pMessage,unsigned int MessageSeqNo);

  typedef SECURITY_STATUS (WINAPI *MAKE_SIGNATURE_FN)(PCtxtHandle,unsigned int,PSecBufferDesc,unsigned int);

  KSECDDDECLSPEC SECURITY_STATUS WINAPI VerifySignature(PCtxtHandle phContext,PSecBufferDesc pMessage,unsigned int MessageSeqNo,unsigned int *pfQOP);

  typedef SECURITY_STATUS (WINAPI *VERIFY_SIGNATURE_FN)(PCtxtHandle,PSecBufferDesc,unsigned int,unsigned int *);

#define SECQOP_WRAP_NO_ENCRYPT 0x80000001
#define SECQOP_WRAP_OOB_DATA 0x40000000

  SECURITY_STATUS WINAPI EncryptMessage(PCtxtHandle phContext,unsigned int fQOP,PSecBufferDesc pMessage,unsigned int MessageSeqNo);

  typedef SECURITY_STATUS (WINAPI *ENCRYPT_MESSAGE_FN)(PCtxtHandle,unsigned int,PSecBufferDesc,unsigned int);

  SECURITY_STATUS WINAPI DecryptMessage(PCtxtHandle phContext,PSecBufferDesc pMessage,unsigned int MessageSeqNo,unsigned int *pfQOP);

  typedef SECURITY_STATUS (WINAPI *DECRYPT_MESSAGE_FN)(PCtxtHandle,PSecBufferDesc,unsigned int,unsigned int *);

  KSECDDDECLSPEC SECURITY_STATUS WINAPI EnumerateSecurityPackagesW(unsigned int *pcPackages,PSecPkgInfoW *ppPackageInfo);

  typedef SECURITY_STATUS (WINAPI *ENUMERATE_SECURITY_PACKAGES_FN_W)(unsigned int *,PSecPkgInfoW *);

  SECURITY_STATUS WINAPI EnumerateSecurityPackagesA(unsigned int *pcPackages,PSecPkgInfoA *ppPackageInfo);

  typedef SECURITY_STATUS (WINAPI *ENUMERATE_SECURITY_PACKAGES_FN_A)(unsigned int *,PSecPkgInfoA *);
...
#define SaslIdentifyPackage __MINGW_NAME_AW(SaslIdentifyPackage)
  ...
  SECURITY_STATUS WINAPI SaslInitializeSecurityContextW(PCredHandle phCredential,PCtxtHandle phContext,LPWSTR pszTargetName,unsigned int fContextReq,unsigned int Reserved1,unsigned int TargetDataRep,PSecBufferDesc pInput,unsigned int Reserved2,PCtxtHandle phNewContext,PSecBufferDesc pOutput,unsigned int *pfContextAttr,PTimeStamp ptsExpiry);
  SECURITY_STATUS WINAPI SaslInitializeSecurityContextA(PCredHandle phCredential,PCtxtHandle phContext,LPSTR pszTargetName,unsigned int fContextReq,unsigned int Reserved1,unsigned int TargetDataRep,PSecBufferDesc pInput,unsigned int Reserved2,PCtxtHandle phNewContext,PSecBufferDesc pOutput,unsigned int *pfContextAttr,PTimeStamp ptsExpiry);

#define SaslInitializeSecurityContext __MINGW_NAME_AW(SaslInitializeSecurityContext)

  SECURITY_STATUS WINAPI SaslAcceptSecurityContext(PCredHandle phCredential,PCtxtHandle phContext,PSecBufferDesc pInput,unsigned int fContextReq,unsigned int TargetDataRep,PCtxtHandle phNewContext,PSecBufferDesc pOutput,unsigned int *pfContextAttr,PTimeStamp ptsExpiry);
...
unsigned int SEC_ENTRY SspiPromptForCredentialsW(
...
unsigned int SEC_ENTRY SspiPromptForCredentialsA(
  PCSTR pszTargetName,
#ifdef _CREDUI_INFO_DEFINED
...
SECURITY_STATUS SEC_ENTRY SspiUnmarshalAuthIdentity(unsigned int AuthIdentityLength,
                                                    char* AuthIdentityByteArray,
                                                    PSEC_WINNT_AUTH_IDENTITY_OPAQUE* ppAuthIdentity);

BOOLEAN SEC_ENTRY SspiIsPromptingNeeded(unsigned int ErrorOrNtStatus);
